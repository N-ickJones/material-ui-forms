...
function FormViewAuto(props) {
    ...
    const onChange = (e, index, property, value) => {
        ...
        if (handler.current.forms)
            handler.current.forms[index] = Object.assign(Object.assign({}, handler.current.forms[index]), { [property]: value });
    ...
    const handleLocalChanges = async () => {
        if (locked)
            return;
        handler.current.forms && localStorage.setItem(localStorageKey, functions_1.encrypt(JSON.stringify([...handler.current.forms]), localStorageKey));
        handleChanges();
    };
            ...
            react_1.default.createElement(material_1.Paper, { ref: printComponentRef, style: printMode ? paperStyle : {} },
                react_1.default.createElement(material_1.Box, { p: printMode ? 0 : 3 },
                    ...
                    react_1.default.createElement(material_1.Grid, { container: true, spacing: 3 },
                        react_1.default.createElement(material_1.Grid, { item: true, xs: 12 },
                            handler.current.forms && handler.current.forms.map((item, index) => {
...
//# sourceMappingURL=FormViewAuto.js.map