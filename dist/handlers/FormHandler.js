    ...
    function FormHandler(args) {
        ...
        this.addNew = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                this.uuid -= 1;
                //@ts-ignore
                this.setState(__spreadArrays(this.forms, [(_a = {}, _a[this.key] = this.uuid, _a)]));
                return [2 /*return*/];
            });
        }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(objectId !== undefined && __1.isValidId(objectId))) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_a) {
                ...
                this.forms.forEach(function (object, index) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(object[this.key] !== undefined && __1.isValidId(object[this.key]))) return [3 /*break*/, 2];
        ...
        this.saveChanges = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.formsState(__spreadArrays(this.forms));
                return [2 /*return*/, true];
            });
        }); };
        this.generateKey = function (item) {
            //@ts-ignore
            return "" + _this.key + item[_this.key];
        };
