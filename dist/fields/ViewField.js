...
const Grid_1 = __importDefault(require("@material-ui/core/Grid/Grid"));
const TextField_1 = __importDefault(require("@material-ui/core/TextField/TextField"));
function ViewField(props) {
    return (react_1.default.createElement(Grid_1.default, { item: true, xs: props.xs || 12, ref: props.printRef },
