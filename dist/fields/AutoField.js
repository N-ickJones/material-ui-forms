...
export function AutoField(props) {
    ...
    return (React.createElement("div", null,
        React.createElement(Autocomplete, { options: props.options ? props.options : [], getOptionLabel: (option) => option.label, fullWidth: true, getOptionSelected: handleOptionSelected, onChange: onChange, value: choiceValue || { label: "", value: "" }, getOptionDisabled: () => props.locked || false, renderInput: (params) => (React.createElement(TextField, Object.assign({}, params, { label: props.label, variant: props.variant || "outlined", inputProps: Object.assign(Object.assign({}, params.inputProps), { autoComplete: 'new-password' }), required: props.required }))), filterOptions: createFilterOptions({
                ignoreCase: true
            }) })));
}
