...
function AutoField(props) {
    var _a = react_1.useState(props.options ? props.options.find(function (item) { return item.value === props.value; }) : { label: "", value: "" }), choiceValue = _a[0], setChoiceValue = _a[1];
