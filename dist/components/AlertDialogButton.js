...
function AlertDialogButton(props) {
    ...
    return (react_1.default.createElement(material_1.Grid, { className: props.className, style: props.style },
        react_1.default.createElement(Button_1.default, { ref: props.submitButtonRef, className: props.btnClass, style: props.btnStyle, variant: props.variant || "outlined", sx: { color: props.color ? props.color : "primary" }, onClick: () => handleClick(), disabled: props.disabled }, props === null || props === void 0 ? void 0 : props.label),
        react_1.default.createElement(Dialog_1.default, { open: open, onClose: () => handleClose(), "aria-labelledby": `alert-${props.id}-title`, "aria-describedby": `alert-${props.id}-description` },
            ...
            react_1.default.createElement(DialogActions_1.default, null,
                react_1.default.createElement(Button_1.default, { onClick: () => handleClose(), sx: { color: props.color ? props.color : "primary" } }, props === null || props === void 0 ? void 0 : props.backLabel),
                react_1.default.createElement(Button_1.default, { onClick: () => handleClose(true), sx: { color: props.color ? props.color : "primary" }, autoFocus: true }, props === null || props === void 0 ? void 0 : props.forwardLabel)))));
}
