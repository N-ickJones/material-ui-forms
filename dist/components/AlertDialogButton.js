...
function AlertDialogButton(props) {
    ...
    return (react_1.default.createElement(core_1.Grid, { className: props.className, style: props.style },
        react_1.default.createElement(Button_1.default, { ref: props.submitButtonRef, className: props.btnClass, style: props.btnStyle, variant: props.variant || "outlined", color: props.color ? props.color : "primary", onClick: () => handleClick(), disabled: props.disabled }, props === null || props === void 0 ? void 0 : props.label),
