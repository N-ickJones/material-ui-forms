...
function AlertDialog(props) {
    ...
    ;
    return (react_1.default.createElement(material_1.Dialog, { open: true, onClose: function () { return handleClose(!props.backOnOutsideClick || false); }, "aria-labelledby": "alert-" + props.id + "-title", "aria-describedby": "alert-" + props.id + "-description", className: props.className, style: props.style },
        react_1.default.createElement(material_1.DialogTitle, { id: "alert-" + props.id + "-title" }, props.title || "Alert"),
        react_1.default.createElement(material_1.DialogContent, null,
            react_1.default.createElement(material_1.DialogContentText, { id: "alert-" + props.id + "-description" }, props.description || "Are you sure?")),
