...
export function combineDupes(input: string, patterns: any): string;
export function hasSpecialChars(str: any): boolean;
export function toPosixPath(str: any): string;
export function unescape(str: string): string;
export function stripDrive(fp: string): string;
export function stripPrefix(str: any): string;
export function isSimpleChar(str: string): boolean;
