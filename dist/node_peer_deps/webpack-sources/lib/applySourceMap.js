...
var applySourceMap = function (sourceNode, sourceMapConsumer, sourceFile, removeGeneratedCodeForSourceFile) {
    ...
    sourceNode.walk(function (chunk, middleMapping) {
        ...
        if (middleMapping.source === sourceFile &&
            middleMapping.line &&
                ...
                if (middleSourceLines &&
                    ...
                    if (rightLine) {
                        ...
                        if (!m2rBestFit.name && middleMapping.name) {
                            allowMiddleName =
                                rightLine.slice(m2rBestFit.originalColumn, m2rBestFit.originalColumn + middleMapping.name.length) === middleMapping.name;
                        }
                    }
                }
...
//# sourceMappingURL=applySourceMap.js.map