...
const ssriOpts = (opts = {}) => (Object.assign(Object.assign({}, defaultOpts), opts));
...
class IntegrityStream extends MiniPass {
    ...
    [_getOptions]() {
        const { integrity, size, options } = Object.assign(Object.assign({}, defaultOpts), this.opts);
        // For verification
...
class Hash {
    ...
    constructor(hash, opts) {
        ...
        const match = this.source.match(strict
            ? STRICT_SRI_REGEX
            : SRI_REGEX);
        if (!match) {
            return;
...
class Integrity {
    ...
    match(integrity, opts) {
        ...
        return (this[algo] &&
            other[algo] &&
            this[algo].find(hash => other[algo].find(otherhash => hash.digest === otherhash.digest))) || false;
    }
    pickAlgorithm(opts) {
        opts = ssriOpts(opts);
