    ...
    compile(expected, schema) {
        function callback(data) {
            ...
            if (isExclamationMarkPresent) {
                callback.errors = [
                    errorMessage(schema, data, `The provided value ${JSON.stringify(data)} contains exclamation mark (!) which is not allowed because it's reserved for loader syntax.`)
                ];
                passes = false;
            }
...
//# sourceMappingURL=ajv.absolutePath.js.map