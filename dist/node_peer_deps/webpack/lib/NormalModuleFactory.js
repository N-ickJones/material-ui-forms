...
const { Tapable, AsyncSeriesWaterfallHook, SyncWaterfallHook, SyncBailHook, SyncHook, HookMap } = require("tapable");
    ...
    constructor(context, resolverFactory, options) {
        ...
        this._pluginCompat.tap("NormalModuleFactory", options => {
            ...
            if (match) {
                this.hooks.parser
                    .for(match[1])
                    .tap(options.fn.name || "unnamed compat plugin", options.fn.bind(this));
                return true;
            }
        ...
        this.hooks.resolver.tap("NormalModuleFactory", () => (data, callback) => {
            ...
            asyncLib.parallel([
                ...
                const userRequest = (matchResource !== undefined ? `${matchResource}!=!` : "") +
                    loaders
                        .map(loaderToIdent)
                        .concat([resource])
                        .join("!");
