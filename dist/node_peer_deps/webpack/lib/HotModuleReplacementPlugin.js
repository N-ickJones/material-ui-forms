    ...
    apply(compiler) {
        ...
        const addParserPlugins = (parser, parserOptions) => {
            parser.hooks.expression
                ...
                .tap("HotModuleReplacementPlugin", ParserHelpers.toConstantDependencyWithWebpackRequire(parser, "__webpack_require__.h()"));
            parser.hooks.evaluateTypeof
                .for("__webpack_hash__")
                .tap("HotModuleReplacementPlugin", ParserHelpers.evaluateToString("string"));
        ...
        compiler.hooks.compilation.tap("HotModuleReplacementPlugin", (compilation, { normalModuleFactory }) => {
            ...
            compilation.hooks.additionalChunkAssets.tap("HotModuleReplacementPlugin", () => {
                ...
                for (const key of Object.keys(records.chunkHashs)) {
                    ...
                    if (currentChunk) {
                        ...
                        if (newModules.length > 0 || removedModules.length > 0) {
                            ...
                            const { path: filename, info: assetInfo } = compilation.getPathWithInfo(hotUpdateChunkFilename, {
                                hash: records.hash,
                                chunk: currentChunk
                            });
                            compilation.additionalChunkAssets.push(filename);
                            compilation.emitAsset(filename, source, Object.assign({ hotModuleReplacement: true }, assetInfo));
                ...
                const { path: filename, info: assetInfo } = compilation.getPathWithInfo(hotUpdateMainFilename, {
                    hash: records.hash
                });
                compilation.emitAsset(filename, source, Object.assign({ hotModuleReplacement: true }, assetInfo));
            });
            ...
            mainTemplate.hooks.requireExtensions.tap("HotModuleReplacementPlugin", source => {
                ...
                buf.push(mainTemplate.requireFn +
            ...
            mainTemplate.hooks.bootstrap.tap("HotModuleReplacementPlugin", (source, chunk, hash) => {
                ...
                return Template.asString([
                    ...
                    hotInitCode
                        ...
                        .replace(/\/\*foreachInstalledChunks\*\//g, needChunkLoadingCode(chunk)
...
//# sourceMappingURL=HotModuleReplacementPlugin.js.map