...
const getTaskForFile = (file, asset, chunk, options, compilation) => {
    ...
    if (!sourceMap || typeof source !== "string")
        return;
            ...
            (context, chunks) => {
                ...
                tasks.forEach((task, index) => {
                    ...
                    if (sourceMapFilename) {
                         ...
                         */
                        if (currentSourceMappingURLComment !== false) {
                            const asset = new ConcatSource(new RawSource(source), compilation.getPath(currentSourceMappingURLComment, Object.assign({ url: sourceMapUrl }, pathParams)));
                            assets[file] = asset;
                         ...
                         */
                        const asset = new ConcatSource(new RawSource(source), currentSourceMappingURLComment
