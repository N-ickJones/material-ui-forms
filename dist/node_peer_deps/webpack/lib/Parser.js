...
class Parser extends Tapable {
            ...
            if (expr.operator === "+") {
                ...
                if (left.isString()) {
                    if (right.isString()) {
                        ...
                        res.setWrapped(new BasicEvaluatedExpression()
                    ...
                    if (left.postfix && left.postfix.isString() && right.isString()) {
                        ...
                        res.setWrapped(left.prefix, new BasicEvaluatedExpression()
                            ...
                            .setRange(right.range), left.wrappedInnerExpressions);
                    }
                    else if (right.isWrapped()) {
                        ...
                        res.setWrapped(left.prefix, null, left.wrappedInnerExpressions &&
                            left.wrappedInnerExpressions.concat(left.postfix ? [left.postfix, right] : [right]));
                    }
                }
                else {
                    if (right.isString()) {
    ...
    blockPrewalkVariableDeclaration(statement) {
        if (statement.kind === "var")
            return;
        const hookMap = statement.kind === "const"
        ...
        switch (expression.type) {
            case "BinaryExpression":
                if (expression.operator === "+") {
                    return (this.parseString(expression.left) +
