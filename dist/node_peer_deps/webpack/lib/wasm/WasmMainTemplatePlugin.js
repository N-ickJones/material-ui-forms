...
class WasmMainTemplatePlugin {
    ...
    apply(mainTemplate) {
        ...
        mainTemplate.hooks.requireEnsure.tap("WasmMainTemplatePlugin", (source, chunk, hash) => {
            ...
            if (Object.keys(chunkModuleMaps.id).length === 0)
                return source;
            ...
            const createImportObject = content => this.mangleImports
                ...
                Template.indent([
                    ...
                    Template.indent([
                        ...
                        this.supportsStreaming
                            ? Template.asString([
                                ...
                                Template.indent([
                                    ...
                                    Template.indent([
                                        `return WebAssembly.instantiate(items[0], ${createImportObject("items[1]")});`
                                    ]),
                                    "});"
                                ]),
                                "} else if(typeof WebAssembly.instantiateStreaming === 'function') {",
                                Template.indent([
                                    `promise = WebAssembly.instantiateStreaming(req, ${createImportObject("importObject")});`
                                ])
                            ])
                            : Template.asString([
                        ...
                        Template.indent([
                            ...
                            Template.indent([
                                `return WebAssembly.instantiate(bytes, ${createImportObject("importObject")});`
                            ]),
                            "});"
                        ]),
                        "}",
...
//# sourceMappingURL=WasmMainTemplatePlugin.js.map