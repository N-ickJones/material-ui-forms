...
const { moduleContextFromModuleAST } = require("@webassemblyjs/helper-module-context");
 ...
 * @returns {ArrayBufferTransform} transform
 */
const addInitFunction = ({ ast, initFuncId, startAtFuncOffset, importedGlobals, additionalInitCode, nextFuncIndex, nextTypeIndex }) => bin => {
...
class WebAssemblyGenerator extends Generator {
    ...
    generate(module, dependencyTemplates, runtimeTemplate, type) {
        ...
        const initFuncId = t.identifier(Array.isArray(module.usedExports)
        ...
        const externalExports = new Set(module.dependencies
        ...
        const transform = compose(rewriteExportNames({
            ...
            module,
            externalExports
        }), removeStartFunc({ ast }), rewriteImportedGlobals({ ast, additionalInitCode }), rewriteImports({
            ast,
            usedDependencyMap
        }), addInitFunction({
            ast,
...
//# sourceMappingURL=WebAssemblyGenerator.js.map