...
const getMappingFromInfo = (info, exportName) => {
    ...
    if (staticMappings !== undefined) {
        if (staticMappings.length === 1)
            return staticMappings[0];
        return undefined;
    }
                    ...
                    for (let i = 0; i < module.reasons.length; i++) {
                        ...
                        if ((dep instanceof HarmonyExportImportedSpecifierDependency ||
                            ...
                            if (mapping) {
                                ...
                                mapping.module.addReason(reason.module, dep, reason.explanation
                                    ? reason.explanation +
...
//# sourceMappingURL=SideEffectsFlagPlugin.js.map