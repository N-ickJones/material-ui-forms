...
class WebpackOptionsDefaulter extends OptionsDefaulter {
    constructor() {
        ...
        this.set("optimization.portableRecords", "make", options => !!(options.recordsInputPath ||
        ...
        this.set("resolve.cacheWithContext", "make", options => {
            return (Array.isArray(options.resolve.plugins) &&
        ...
        this.set("resolveLoader.cacheWithContext", "make", options => {
            return (Array.isArray(options.resolveLoader.plugins) &&
...
//# sourceMappingURL=WebpackOptionsDefaulter.js.map