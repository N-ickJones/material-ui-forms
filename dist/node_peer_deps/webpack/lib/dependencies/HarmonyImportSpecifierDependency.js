    ...
    _getErrors() {
        ...
        if (!importedModule.buildMeta || !importedModule.buildMeta.exportsType) {
            ...
            if (this.originModule.buildMeta.strictHarmonyModule &&
                ...
                return [
                    new HarmonyLinkingError(`Can't import the named export '${this._id}' from non EcmaScript module (only default export is available)`)
                ];
            }
            return;
        }
...
//# sourceMappingURL=HarmonyImportSpecifierDependency.js.map