...
class WebAssemblyImportDependency extends ModuleDependency {
    ...
    getErrors() {
        if (this.onlyDirectImport &&
            this.module &&
            !this.module.type.startsWith("webassembly")) {
            return [
                new UnsupportedWebAssemblyFeatureError(`Import "${this.name}" from "${this.request}" with ${this.onlyDirectImport} can only be used for direct wasm to wasm dependencies`)
            ];
        }
    }
    get type() {
...
//# sourceMappingURL=WebAssemblyImportDependency.js.map