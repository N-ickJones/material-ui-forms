...
class AMDRequireDependenciesBlockParserPlugin {
    ...
    apply(parser) {
        parser.hooks.call
            .for("require")
            .tap("AMDRequireDependenciesBlockParserPlugin", this.processCallRequire.bind(this, parser));
    }
            ...
            try {
                ...
                if (!result) {
                    ...
                    if (parser.state.module) {
                        parser.state.module.errors.push(new UnsupportedFeatureWarning(parser.state.module, "Cannot statically analyse 'require(…, …)' in line " +
                            expr.loc.start.line, expr.loc));
                    }
                    dep = null;
                    return true;
                }
...
//# sourceMappingURL=AMDRequireDependenciesBlockParserPlugin.js.map