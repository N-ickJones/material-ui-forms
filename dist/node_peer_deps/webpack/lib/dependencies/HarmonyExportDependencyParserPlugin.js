...
module.exports = class HarmonyExportDependencyParserPlugin {
    ...
    apply(parser) {
        ...
        parser.hooks.exportExpression.tap("HarmonyExportDependencyParserPlugin", (statement, expr) => {
            ...
            const dep = new HarmonyExportExpressionDependency(parser.state.module, expr.range, statement.range, comments
                .map(c => {
                switch (c.type) {
                    case "Block":
                        return `/*${c.value}*/`;
...
//# sourceMappingURL=HarmonyExportDependencyParserPlugin.js.map