    ...
    apply(compilation) {
        ...
        const onRenderWithEntry = (source, chunk, hash) => {
            ...
            const externalsDepsArray = modules => {
                return `[${replaceKeys(modules
                    .map(m => JSON.stringify(typeof m.request === "object" ? m.request.amd : m.request))
                    .join(", "))}]`;
            };
            ...
            const externalsArguments = modules => {
                return modules
                    .map(m => `__WEBPACK_EXTERNAL_MODULE_${Template.toIdentifier(`${m.id}`)}__`)
                    .join(", ");
            };
...
//# sourceMappingURL=UmdMainTemplatePlugin.js.map