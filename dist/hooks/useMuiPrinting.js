...
function useMuiPrinting(paper, margin) {
    var _this = this;
    var _a = react_1.useState(false), printMode = _a[0], setPrintMode = _a[1];
    var pageBreaks = [];
    var printComponentRef = react_1.useRef();
    ...
    var displayPrintFunc = react_to_print_1.useReactToPrint({
        //bodyClass: "",
