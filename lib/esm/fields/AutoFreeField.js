...
export function AutoFreeField(props) {
    ...
    return (React.createElement(Autocomplete, { className: props.className, style: props.style, fullWidth: true, placeholder: props.placeholder, options: props.options ? props.options : [], getOptionLabel: function (option) { return option.label; }, freeSolo: true, onInputChange: onInputChange, inputValue: value || "", getOptionDisabled: function () { return props.locked || false; }, renderInput: function (params) { return (React.createElement(TextField, __assign({}, params, { label: props.label, variant: props.variant || "outlined", inputProps: __assign(__assign({}, params.inputProps), { autoComplete: 'new-password' }), required: props.required, helperText: error, error: !!error, className: props.inputClassName, style: props.inputStyle }))); }, filterOptions: createFilterOptions({
            ignoreCase: true
        }) }));
}
