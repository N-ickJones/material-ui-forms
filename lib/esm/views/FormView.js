                        ...
                        React.createElement(Grid, { item: true, xs: 12 },
                            ...
                            props.forms && props.forms.length < 1 &&
                                React.createElement(Grid, null,
                                    React.createElement(Typography, { align: "center", sx: { padding: "1em" } }, "There are currently no forms to edit.")),
                            !props.FormElement && React.createElement(Grid, null,
                                React.createElement(Typography, { align: "center", sx: { padding: "1em" } }, "Development Error: Form Element is not defined.")),
                            !props.forms && React.createElement(Grid, null,
                                React.createElement(Typography, { align: "center", sx: { padding: "1em" } }, "Development Error: Forms is not defined"))),
                        React.createElement(Grid, { item: true, xs: 12 },
                            props.forms && props.forms.length < (props.maxNodes ? props.maxNodes : 1) && (React.createElement(Grid, { container: true },
                                React.createElement(Button, { sx: !locked ? { margin: "0.25em 0.25em 0.25em auto" } : { display: "none" }, variant: "contained", color: "primary", onClick: props.handleAddNewItem }, "Add New Item"))),
                            React.createElement(Box, { width: "100%", my: 3 },
                                React.createElement(Divider, null))),
