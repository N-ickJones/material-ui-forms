...
import { Backdrop, CircularProgress, Box, Paper, Grid, Typography, Divider, Button } from "@mui/material";
                    ...
                    React.createElement(Grid, { container: true, spacing: 3 },
                        ...
                        React.createElement(Grid, { item: true, xs: 12 },
                            handler.current.forms && handler.current.forms.length < (props.maxNodes ? props.maxNodes : 1) && (React.createElement(Grid, { container: true },
                                React.createElement(Button, { className: !locked ? classes.marginLeftAuto : classes.displayNone, variant: "contained", color: "primary", onClick: handler.current.addNew }, "Add New Item"))),
                            React.createElement(Box, { width: "100%", my: 3 },
                                React.createElement(Divider, null))),
