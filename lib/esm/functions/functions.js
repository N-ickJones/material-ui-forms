...
export var getPaperHeight = function (paper) {
    return paper ? paper.dpi * paper.height / paper.ratio : a4.dpi * a4.height / a4.ratio;
};
export var getPaperWidth = function (paper) {
    return paper ? paper.dpi * paper.width / paper.ratio : a4.dpi * a4.width / a4.ratio;
    ;
};
export var marginToPixels = function (paper, margin) {
    return paper.dpi * (margin ? margin : 25) / paper.ratio;
};
export var formIsValid = function () { return __awaiter(void 0, void 0, void 0, function () {
...
export var onChange = function (setState) { return function (e, property, value) {
