...
function useMuiPrinting(paper, margin) {
    var _this = this;
    var _a = (0, react_1.useState)(false), printMode = _a[0], setPrintMode = _a[1];
    var pageBreaks = [];
    var printComponentRef = (0, react_1.useRef)();
    var inputRefs = (0, react_1.useRef)([]);
    var defaultMargin = { top: 25, bottom: 25, left: 25, right: 25 };
    var paperStyle = {
        width: (0, functions_1.getPaperWidth)(paper),
        minHeight: (0, functions_1.getPaperHeight)(paper),
    ...
    var addPageBreaks = function (paper, margin) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            props = {
                pageHeight: (0, functions_1.getPaperHeight)(paper),
                marginTop: (0, functions_1.marginToPixels)(paper, margin.top),
                marginBottom: (0, functions_1.marginToPixels)(paper, margin.bottom)
            };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, __1.sleep)(3000)];
                case 1:
                    //Find a better way to ensure order of operations...
                    _a.sent();
                    return [4 /*yield*/, addPageBreaks(paper || __1.a4, margin || defaultMargin)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var displayPrintFunc = (0, react_to_print_1.useReactToPrint)({
        //bodyClass: "",
