...
function FormView(props) {
    ...
    var localStorageKey = props.title ? props.title.replace(" ", "") : (0, __1.uuidv4)();
    //const printComponentRef = useRef();
    var _a = (0, react_1.useState)(props.defaultLocked === undefined ? false : (props.defaultLocked ? (props.hideLockButton ? false : true) : false)), locked = _a[0], setLocked = _a[1];
    //const [printMode, setPrintMode] = useState(false);
    var _b = (0, react_1.useState)(false), pendingChanges = _b[0], setPendingChanges = _b[1];
    var _c = (0, react_1.useState)(false), loadLocal = _c[0], setLoadLocal = _c[1];
    var _d = (0, react_1.useState)(false), loadServer = _d[0], setLoadServer = _d[1];
    var snackbar = (0, __1.SnackBarComponent)(8000);
    (0, __1.useWarnIfUnsavedChanges)(pendingChanges);
    var _e = (0, __1.useMuiPrinting)(), paperStyle = _e[0], printComponentRef = _e[1], printMode = _e[2], displayPrint = _e[3], handlePrintRef = _e[4];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    plainText = (0, __1.decrypt)(cipherText, localStorageKey);
                    _a = props.handleLoad;
                    if (!_a) return [3 /*break*/, 2];
    ...
    var handleLocalChanges = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (locked)
                return [2 /*return*/];
            props.forms && localStorage.setItem(localStorageKey, (0, __1.encrypt)(JSON.stringify(__spreadArray([], props.forms, true)), localStorageKey));
            handleChanges();
            return [2 /*return*/];
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, __1.formIsValid)()];
                case 1:
    ...
    if (loadLocal) {
        ...
        return (react_1.default.createElement(material_1.Backdrop, { sx: {
                        ...
                        react_1.default.createElement(material_1.Grid, { item: true, xs: 12 },
                            ...
                            props.forms && props.forms.length < 1 &&
                                react_1.default.createElement(material_1.Grid, null,
                                    react_1.default.createElement(material_1.Typography, { align: "center", sx: { padding: "1em" } }, "There are currently no forms to edit.")),
                            !props.FormElement && react_1.default.createElement(material_1.Grid, null,
                                react_1.default.createElement(material_1.Typography, { align: "center", sx: { padding: "1em" } }, "Development Error: Form Element is not defined.")),
                            !props.forms && react_1.default.createElement(material_1.Grid, null,
                                react_1.default.createElement(material_1.Typography, { align: "center", sx: { padding: "1em" } }, "Development Error: Forms is not defined"))),
                        react_1.default.createElement(material_1.Grid, { item: true, xs: 12 },
                            props.forms && props.forms.length < (props.maxNodes ? props.maxNodes : 1) && (react_1.default.createElement(material_1.Grid, { container: true },
                                react_1.default.createElement(material_1.Button, { sx: !locked ? { margin: "0.25em 0.25em 0.25em auto" } : { display: "none" }, variant: "contained", color: "primary", onClick: props.handleAddNewItem }, "Add New Item"))),
                            react_1.default.createElement(material_1.Box, { width: "100%", my: 3 },
                                react_1.default.createElement(material_1.Divider, null))),
