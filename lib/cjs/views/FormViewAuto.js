...
exports.FormViewAuto = void 0;
var react_1 = __importStar(require("react"));
var __1 = require("..");
var icons_material_1 = require("@mui/icons-material");
var material_1 = require("@mui/material");
function FormViewAuto(props) {
    var _this = this;
    ...
    var handleLocalChanges = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (locked)
                return [2 /*return*/];
            handler.current.forms && localStorage.setItem(localStorageKey, (0, __1.encrypt)(JSON.stringify(__spreadArray([], handler.current.forms, true)), localStorageKey));
            handleChanges();
            return [2 /*return*/];
        });
    }); };
                ...
                react_1.default.createElement(material_1.Box, { p: printMode ? 0 : 3 },
                    ...
                    react_1.default.createElement(material_1.Grid, { container: true, spacing: 3 },
                        react_1.default.createElement(material_1.Grid, { item: true, xs: 12 },
                            ...
                            " "),
                        react_1.default.createElement(material_1.Grid, { item: true, xs: 12 },
                            handler.current.forms && handler.current.forms.length < (props.maxNodes ? props.maxNodes : 1) && (react_1.default.createElement(material_1.Grid, { container: true },
                                react_1.default.createElement(material_1.Button, { sx: !locked ? { margin: "0.25em 0.25em 0.25em auto" } : { display: "none" }, variant: "contained", color: "primary", onClick: handler.current.addNew }, "Add New Item"))),
                            react_1.default.createElement(material_1.Box, { width: "100%", my: 3 },
                                react_1.default.createElement(material_1.Divider, null))),
...
exports.FormViewAuto = FormViewAuto;
